...
public class CertificateController {
    ...
    @PostMapping("/{candidateId}/add-certificate")
    public ResponseEntity<CertificateResponse> insert(@PathVariable Long candidateId, @RequestBody CertificateCreateDTO objDto) {
